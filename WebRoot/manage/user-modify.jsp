...
<div id="main" class="wrap">
	...
	<div class="main">
		<h2>修改用户</h2>
		<div class="manage">
			<form method="post" action="User?action=save&entityId=${param.entityId}" >
				<table class="form">
					<tr>
					...
					<tr>
						...
						<td><input class="text" type="text" name="identityCode"   value="${identityCode}"/><span></span></td>
					</tr>
					<tr>
						<td class="field">电子邮件：</td>
						<td><input class="text" type="text" name="email"   value="${email}"/>
					...
					<tr>
						...
						<td><input class="text" type="text" name="mobile"   value="${mobile}"/>
